...
class LandingComponent extends Component{
    render(){
        const image1 = require(`../assets/images/roy3.jpg`); //membuat variabel image 1 dimana isinya merupakan importan gambar yang ada dari folder images
                            ...
                            <Row>
                                <Col span={24}>
                                    <div className="title-container">
                                        <span className="text-soft-blue title-big bold">Royandi Nicolas N</span>
                                    </div>
                                </Col>
                                <Col span={24}>
                                    ...
                                    <div className="description-container desc-medium">
                                        mahasiswa biasa yang suka bermain layang-layang, amnesia kalo inget utang, cakep waktu pantun doang. 
                                        <br></br>
                                        Hit me at : 
                                    </div>
                                </Col>
                                ...
                                <Modal
                                    ...
                                    >
                                    <p className="text-notif">kalau mau lebih lanjut kontak aja ya di royandinicolas@mail.ugm.ac.id</p>
